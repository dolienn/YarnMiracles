...
public class CheckoutControllerTest {
    ...
    public void shouldReturnPurchaseResponse() {
        ...
        when(service.placeOrder(any(Purchase.class), any(Authentication.class)))
                .thenReturn(expectedResponse);

        PurchaseResponse actualResponse = checkoutController.placeOrder(Purchase.builder().build(), authentication);
